      ...
      <Card className="relative overflow-hidden border-none shadow-xl lg:col-span-2">
        ...
        <CardContent className="relative p-6">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="flex items-center gap-2 text-xs font-medium uppercase tracking-wider text-primary-foreground/70">
                <Wallet className="h-3.5 w-3.5" /> Saldo em caixa
              </p>
              <p className="mt-1 text-3xl font-bold tracking-tight text-primary-foreground sm:text-4xl">
                {fmtBRL(saldo)}
              </p>
              <p className="mt-1 text-xs text-primary-foreground/70">{periodoLabel}</p>
            </div>
            <div className="rounded-lg bg-primary-foreground/10 px-3 py-2 text-right">
              <p className="text-[10px] uppercase tracking-wider text-primary-foreground/70">Resultado</p>
              <p className={cn("text-lg font-semibold text-primary-foreground")}>
